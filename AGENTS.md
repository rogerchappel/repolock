# Agent Operating Instructions for repolock

This file defines how AI agents and human maintainers should work in `repolock`.

## Project Context

- Project: `repolock`
- Repository: `rogerchappel/repolock`
